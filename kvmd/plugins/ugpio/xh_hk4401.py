...
class Plugin(BaseUserGpioDriver):  # pylint: disable=too-many-instance-attributes
    def __init__(
        ...
        self.__protocol:     Final[int]   = c.protocol  # https://github.com/pikvm/kvmd/pull/158
        ...
        self.__proc = aiomulti.AioMpProcess(f"gpio-xh-hk4401-{self._instance_name}", self.__serial_worker)
